...
-(void) requestData: (NSString *)urlString {
    ...
    [[[SXNetworkTools sharedNetworkTools] GET:urlString parameters:nil progress:nil success:^(NSURLSessionDataTask *task, NSDictionary* responseObject) {
       
        if ([responseObject isKindOfClass:[NSDictionary class]])
        {
            NSArray *array = [responseObject objectForKey:@"song_list"];
            _songInfo.OMSongs = [OMHotSongInfo mj_objectArrayWithKeyValuesArray:array];
            self.isDataRequestFinish = true;
        }
