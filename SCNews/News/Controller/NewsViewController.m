...
{
    if (_arrayLists == nil) {
        _arrayLists = [NSArray arrayWithContentsOfFile:[[NSBundle mainBundle]pathForResource:@"SCNewsURL.plist" ofType:nil]];
    }
    return _arrayLists;
}
-(void)viewDidLoad {
...
-(NSMutableArray *)currentChannelsArray {
    if (!_currentChannelsArray) {
        if (!_currentChannelsArray) {
            _currentChannelsArray = [NSMutableArray arrayWithObjects:@"头条", @"娱乐", @"电影", @"时尚", @"NBA",@"科技", @"手机", nil];
        }
    }
